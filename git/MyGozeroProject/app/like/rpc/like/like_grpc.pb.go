...
const (
	Like_Thumbup_FullMethodName   = "/like.Like/Thumbup"
	Like_IsThumbup_FullMethodName = "/like.Like/IsThumbup"
)
...
func (c *likeClient) Thumbup(ctx context.Context, in *ThumbupRequest, opts ...grpc.CallOption) (*ThumbupResponse, error) {
	...
	err := c.cc.Invoke(ctx, Like_Thumbup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeClient) IsThumbup(ctx context.Context, in *IsThumbupRequest, opts ...grpc.CallOption) (*IsThumbupResponse, error) {
	...
	err := c.cc.Invoke(ctx, Like_IsThumbup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
