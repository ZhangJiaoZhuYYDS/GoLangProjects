// @Author zhangjiaozhu 2023/12/19 22:06:00
package util
...
type Node struct {
	char   rune //rune表示一个utf8字符
	Data   interface{}
	parent *Node
	Depth  int
	childs map[rune]*Node //childs 用来当前节点的所有孩子节点
	term   bool
}
...
//	//result, str := trie.Check("我们这里有一个黄色的傻逼，他存在了很久。他是艹的。", "***")
//}
